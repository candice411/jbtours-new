              ...
              <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
				    ...
				    <td id="heading-center" width="30%" valign="top"><strong>2011 Upmarket<br />
				      Rates &amp; Dates</strong></td>
				    <td align="left" width="35%"><img src="images/heading-right.gif" /></td>
				  </tr>
			  </table>
				<div id="rates-dates"><?php include('upmarket-rates-dates-2011.php'); ?>
                  <p><?php include('../budget-rates-dates-2011.php'); ?></p>
                </div></td>
              </tr>
