...
<title>2012 Upmarket Rates &amp; Dates | JB Train Tours upmarket</title>
<style type="text/css">
<!--
              ...
              <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
				    ...
				    <td id="heading-center" width="30%" valign="top"><strong><?php echo date("Y"); ?> Upmarket<br />
				      Rates &amp; Dates</strong></td>
				    <td align="left" width="35%"><img src="images/heading-right.gif" /></td>
				  </tr>
			  </table>
				<div id="mainContent">
					<?php include('../rates_dates_nav.html'); ?>
               <?php include('../2012/festival_2012.html'); ?>
               <?php include('../2012/footer.html'); ?>
            </div>
            </td>
              </tr>
